...
from scores import fid,ams,utils
import argparse
...
if __name__ == '__main__': 
  ...
  scores [string] (optional)=comma separated string of score abbreviations without any space like "FID,AMS" (defaults to all scores)
  ...
  parser.add_argument('--scores', type=str, default='fid,ams', help="Comma separated string of scores abbreviations without any space (Ex: 'FID,AMS')")
