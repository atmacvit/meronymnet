...
class Pix2pixDataset(BaseDataset):
    ...
    def initialize(self, opt):
        ...
        #     print(label_paths[i], image_paths[i], instance_paths[i], label_paths88[i])
    ...
    def __getitem__(self, index):
        ...
        im_label = self.instance_paths[index]

        input_dict = {'label': label_tensor,
                      'instance': 0,
                      'image': image_tensor,
                      'path': image_path,
                      'class_label': im_label
                      }
        # print(input_dict)
